...
CREATE TABLE `Dancivnyk` (
    `dancivnyk_id` INT AUTO_INCREMENT PRIMARY KEY,
...
-- Create Anketa table
CREATE TABLE `Anketa` (
    `anketa_id` INT AUTO_INCREMENT PRIMARY KEY,
...
-- Create Zvit table
CREATE TABLE `Zvit` (
    `zvit_id` INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `Povidomlennya` (
    `povidomlennya_id` INT AUTO_INCREMENT PRIMARY KEY,
    `tekst` TEXT NOT NULL,
...
CREATE TABLE `OpenAI_API` (
    `openai_api_id` INT AUTO_INCREMENT PRIMARY KEY,
    `api_key` VARCHAR(255) NOT NULL
);

-- Create Psyholog table
CREATE TABLE `Psyholog` (
    `psyholog_id` INT AUTO_INCREMENT PRIMARY KEY,
    `imya` VARCHAR(100) NOT NULL,
